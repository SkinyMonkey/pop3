...
- [ ] 05-02-PLAN.md -- Save/load system with serde + bincode and quicksave
- [ ] 05-03-PLAN.md -- Menu state machine and HUD rendering
...
- [ ] 05-06-PLAN.md -- Campaign progression and OBJECTIV.DAT parser
